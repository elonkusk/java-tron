...
public class FullNodeHttpApiService implements Service {
    ...
    public void start() {
        try {
            ...
            context.addServlet(new ServletHolder(voteWitnessAccountServlet), "/wallet/votewitnessaccount");
            ...
            context.addServlet(new ServletHolder(participateAssetIssueServlet), "/wallet/participateassetissue");
            ...
            context.addServlet(new ServletHolder(getAssetIssueByAccountServlet), "/wallet/getassetissuebyaccount");
            context.addServlet(new ServletHolder(getAccountNetServlet), "/wallet/getaccountnet");
            context.addServlet(new ServletHolder(getAssetIssueByNameServlet), "/wallet/getassetissuebyname");
            context.addServlet(new ServletHolder(getAssetIssueListByNameServlet), "/wallet/getassetissuelistbyname");
            ...
            context.addServlet(new ServletHolder(getBlockByLimitNextServlet), "/wallet/getblockbylimitnext");
            context.addServlet(new ServletHolder(getBlockByLatestNumServlet), "/wallet/getblockbylatestnum");
            context.addServlet(new ServletHolder(getTransactionByIdServlet), "/wallet/gettransactionbyid");
            context.addServlet(new ServletHolder(getTransactionInfoByIdServlet), "/wallet/gettransactioninfobyid");
            context.addServlet(new ServletHolder(getTransactionReceiptByIdServlet), "/wallet/gettransactionreceiptbyid");
            context.addServlet(new ServletHolder(getTransactionCountByBlockNumServlet), "/wallet/gettransactioncountbyblocknum");
            ...
            context.addServlet(new ServletHolder(getPaginatedAssetIssueListServlet), "/wallet/getpaginatedassetissuelist");
            context.addServlet(new ServletHolder(getPaginatedProposalListServlet), "/wallet/getpaginatedproposallist");
            context.addServlet(new ServletHolder(getPaginatedExchangeListServlet), "/wallet/getpaginatedexchangelist");
            context.addServlet(new ServletHolder(totalTransactionServlet), "/wallet/totaltransaction");
            context.addServlet(new ServletHolder(getNextMaintenanceTimeServlet), "/wallet/getnextmaintenancetime");
            ...
            context.addServlet(new ServletHolder(easyTransferByPrivateServlet), "/wallet/easytransferbyprivate");
            context.addServlet(new ServletHolder(easyTransferAssetServlet), "/wallet/easytransferasset");
            context.addServlet(new ServletHolder(easyTransferAssetByPrivateServlet), "/wallet/easytransferassetbyprivate");
            ...
            context.addServlet(new ServletHolder(triggerSmartContractServlet), "/wallet/triggersmartcontract");
            context.addServlet(new ServletHolder(triggerConstantContractServlet), "/wallet/triggerconstantcontract");
            ...
            context.addServlet(new ServletHolder(exchangeTransactionServlet), "/wallet/exchangetransaction");
            ...
            context.addServlet(new ServletHolder(getChainParametersServlet), "/wallet/getchainparameters");
            context.addServlet(new ServletHolder(getAccountResourceServlet), "/wallet/getaccountresource");
            context.addServlet(new ServletHolder(addTransactionSignServlet), "/wallet/addtransactionsign");
            context.addServlet(new ServletHolder(getTransactionSignWeightServlet), "/wallet/getsignweight");
            context.addServlet(new ServletHolder(getTransactionApprovedListServlet), "/wallet/getapprovedlist");
            context.addServlet(new ServletHolder(accountPermissionUpdateServlet), "/wallet/accountpermissionupdate");
            ...
            context.addServlet(new ServletHolder(getDelegatedResourceServlet), "/wallet/getdelegatedresource");
            context.addServlet(new ServletHolder(getDelegatedResourceAccountIndexServlet), "/wallet/getdelegatedresourceaccountindex");
            ...
            context.addServlet(new ServletHolder(getExpandedSpendingKeyServlet), "/wallet/getexpandedspendingkey");
            ...
            context.addServlet(new ServletHolder(getNewShieldedAddressServlet), "/wallet/getnewshieldedaddress");
            context.addServlet(new ServletHolder(getDiversifierServlet), "/wallet/getdiversifier");
            context.addServlet(new ServletHolder(getIncomingViewingKeyServlet), "/wallet/getincomingviewingkey");
            context.addServlet(new ServletHolder(getZenPaymentAddressServlet), "/wallet/getzenpaymentaddress");
            ...
            context.addServlet(new ServletHolder(isShieldedTRC20ContractNoteSpentServlet), "/wallet/isshieldedtrc20contractnotespent");
            context.addServlet(new ServletHolder(createShieldedContractParametersServlet), "/wallet/createshieldedcontractparameters");
            context.addServlet(new ServletHolder(createShieldedContractParametersWithoutAskServlet), "/wallet/createshieldedcontractparameterswithoutask");
            context.addServlet(new ServletHolder(scanShieldedTRC20NotesByIvkServlet), "/wallet/scanshieldedtrc20notesbyivk");
            context.addServlet(new ServletHolder(scanShieldedTRC20NotesByOvkServlet), "/wallet/scanshieldedtrc20notesbyovk");
            context.addServlet(new ServletHolder(getTriggerInputForShieldedTRC20ContractServlet), "/wallet/gettriggerinputforshieldedtrc20contract");
            ...
            context.addServlet(new ServletHolder(createCommonTransactionServlet), "/wallet/createCommonTransaction");
            context.addServlet(new ServletHolder(getTransactionInfoByBlockNumServlet), "/wallet/gettransactioninfobyblocknum");
            ...
            context.addServlet(new ServletHolder(getMarketOrderByAccountServlet), "/wallet/getmarketorderbyaccount");
            context.addServlet(new ServletHolder(getMarketOrderByIdServlet), "/wallet/getmarketorderbyid");
            context.addServlet(new ServletHolder(getMarketPriceByPairServlet), "/wallet/getmarketpricebypair");
            context.addServlet(new ServletHolder(getMarketOrderListByPairServlet), "/wallet/getmarketorderlistbypair");
            context.addServlet(new ServletHolder(getMarketPairListServlet), "/wallet/getmarketpairlist");

            context.addServlet(new ServletHolder(getAccountBalanceServlet), "/wallet/getaccountbalance");
            context.addServlet(new ServletHolder(getBlockBalanceServlet), "/wallet/getblockbalance");
            ...
            context.addFilter(new FilterHolder(liteFnQueryHttpFilter), "/*", EnumSet.allOf(DispatcherType.class));

            // http access filter, it should have higher priority than HttpInterceptor
            context.addFilter(new FilterHolder(httpApiAccessFilter), "/*", EnumSet.allOf(DispatcherType.class));
            // note: if the pathSpec of servlet is not started with wallet, it should be included here
            context.getServletHandler().getFilterMappings()[1].setPathSpecs(new String[]{"/wallet/*",
                            "/net/listnodes",
